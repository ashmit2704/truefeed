...
const Dashboard = () => {
  ...
  const handleDeleteMessage = (messageId: Object) => {
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded-2xl w-full max-w-11/12">
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center">
          <input
            ...
            value={profileUrl}
            disabled
            className="input input-bordered w-full p-2 mr-2 outline rounded-lg"
          />
